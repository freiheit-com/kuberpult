...
BEGIN
    ...
    ALTER TABLE releases_history DROP CONSTRAINT releases_history_pkey;
    ALTER TABLE releases_history ADD PRIMARY KEY (eslVersion, eslVersion, releaseVersion, revision);
END IF;
END $$;
