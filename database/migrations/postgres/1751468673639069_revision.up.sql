...
BEGIN
    ...
    ALTER TABLE IF EXISTS releases ADD COLUMN revision VARCHAR NOT NULL DEFAULT '0';
END IF;
END $$;
...
ALTER TABLE IF EXISTS releases_history ADD COLUMN revision VARCHAR NOT NULL DEFAULT '0';
END IF;
END $$;
...
ALTER TABLE IF EXISTS deployments ADD COLUMN revision VARCHAR NOT NULL DEFAULT '0';
END IF;
END $$;
...
ALTER TABLE IF EXISTS deployments_history ADD COLUMN revision VARCHAR NOT NULL DEFAULT '0';
END IF;
END $$;
...
ALTER TABLE IF EXISTS deployment_attempts ADD COLUMN revision VARCHAR NOT NULL DEFAULT '0';
END IF;
END $$;