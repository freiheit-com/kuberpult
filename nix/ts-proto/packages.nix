...
in
{
  ts-proto = nodeEnv.buildNodePackage {
    ...
    version = "1.104.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/ts-proto/-/ts-proto-1.104.0.tgz";
      sha512 = "5inaRz7+uT2dmfQagBOeqEaeYWzCpgWvG4XOKTj5t+V8MI5Fqr3kpNQ1fHLAy4+/kno2xrtrFKNttmZx/eYPIg==";
    };
    dependencies = [
      ...
      sources."ts-proto-descriptors-1.3.1"
    ];
