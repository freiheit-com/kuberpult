...
func (r *repository) processApp(
	...
	if isAAEnv {
		projectName = r.ArgoProjectNames.ActiveActiveEnvironments[types.EnvName(environmentInfo.GetFullyQualifiedName())]
	} else {
		projectName = r.ArgoProjectNames.Environments[types.EnvName(environmentInfo.GetFullyQualifiedName())]
	}
