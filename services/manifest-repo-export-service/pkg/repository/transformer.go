...
func (u *CreateUndeployApplicationVersion) GetEslID() db.TransformerID {
	return u.TransformerEslID
}

func (c *CreateUndeployApplicationVersion) SetEslID(eslId db.TransformerID) {
	c.TransformerEslID = eslId
}
...
func (u *UndeployApplication) GetEslID() db.TransformerID {
	return u.TransformerEslID
}
