	...
	for _, tc := range tcs {
		t.Run(tc.Name, func(t *testing.T) {
			...
			if !cmp.Equal(tc.expectedApiConfig.Argocd, actualApiConfig.Argocd, cmpopts.IgnoreUnexported(
				api.ArgoCDEnvironmentConfiguration{},
				api.ArgoCDEnvironmentConfiguration_AccessEntry{},
				api.ArgoCDEnvironmentConfiguration_Destination{},
				api.ArgoCDEnvironmentConfiguration_IgnoreDifferences{},
				api.ArgoCDEnvironmentConfiguration_SyncWindows{},
			)) {
