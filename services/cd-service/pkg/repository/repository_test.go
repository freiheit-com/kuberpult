...
func (p *SlowTransformer) SetEslID(_ uint) {
	//Does nothing
}
...
func (p *EmptyTransformer) SetEslID(_ uint) {
	//Does nothing
}
...
func (p *PanicTransformer) SetEslID(_ uint) {
	//Does nothing
}
...
func (p *ErrorTransformer) SetEslID(_ uint) {
	//Does nothing
}
...
func (p *InvalidJsonTransformer) SetEslID(_ uint) {
	//Does nothing
}
