...
The release train deployed 0 services from 'latest' to 'dev'`,
		},
		{
			...
			ReleaseTrainEnv:    "dev",
			shouldSucceed:      false,
			expectedError:      "error at index 0 of transformer batch: error getting upstream latest apps, error: rpc error: code = InvalidArgument desc = error: could not get app version for commitHash 3f1debc97f5880c59caab9b36ad31f52604ce4dd for dev: ErrNotFound: object not found - no match for id (3f1debc97f5880c59caab9b36ad31f52604ce4dd)",
		...
		},
		{
			...
			ReleaseTrainEnv:    "dev",
			shouldSucceed:      false,
			expectedError:      "error at index 0 of transformer batch: error getting upstream latest apps, error: rpc error: code = InvalidArgument desc = error: could not get app version for commitHash aa for dev: Error creating new oid for commitHash aa: invalid oid",
