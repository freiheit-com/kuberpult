                                        ...
                                        if (outcome === undefined) {
                                            ...
                                            switch (outcome.skipCause) {
                                                case ReleaseTrainAppSkipCause.APP_ALREADY_IN_UPSTREAM_VERSION:
                                                    content = (
                                                        <p>
                                                            Application release is skipped because it is already in the
                                                            upstream version.
                                                        </p>
                                                    );
                                                    break;
                                                case ReleaseTrainAppSkipCause.APP_DOES_NOT_EXIST_IN_ENV:
                                                    content = (
                                                        <p>
                                                            Application release is skipped because it does not exist in
                                                            the environment.
                                                        </p>
                                                    );
                                                    break;
                                                case ReleaseTrainAppSkipCause.APP_HAS_NO_VERSION_IN_UPSTREAM_ENV:
                                                    content = (
                                                        <p>
                                                            Application release is skipped because it does not have a
                                                            version in the upstream environment.
                                                        </p>
                                                    );
                                                    break;
                                                case ReleaseTrainAppSkipCause.APP_IS_LOCKED:
                                                    content = (
                                                        <p>Application release is skipped because it is locked.</p>
                                                    );
                                                    break;
                                                case ReleaseTrainAppSkipCause.APP_IS_LOCKED_BY_ENV:
                                                    content = (
                                                        <p>
                                                            Application release is skipped because there's an
                                                            environment lock where this application is getting deployed.
                                                        </p>
                                                    );
                                                    break;
                                                ...
                                                case ReleaseTrainAppSkipCause.UNRECOGNIZED:
                                                    content = (
                                                        <p>
                                                            Application release it skipped due to an unrecognized reason
                                                        </p>
                                                    );
                                                    break;
                                                default:
