...
//func (s Server) handleAPIExtendAAEnvironment(w http.ResponseWriter, req *http.Request, clusterName, tail string) {
//
//	if tail != "/" {
//		http.Error(w, fmt.Sprintf("Create Environment does not accept additional path arguments, got: '%s'", tail), http.StatusNotFound)
//		return
...
//				CreateEnvironment: &api.BatchAction_ExtendAAEnvironment{
//					Environment: environment,
//					Config:      envConfig,
//				}}},
//		},
